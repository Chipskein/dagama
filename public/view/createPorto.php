...
?>
    ...
    <form class="header-searchBar" name="search" action="/usuarios" method="get">
    ...
    <?php 
      ...
      echo "<a class=\"header-links-a\" href=/logoff.php>Sair </a><img class=\"header-links-icon\" src=\"/imgs/icons/sair.png\" alt=\"\">";
    ?>
    </div>
  </header>
  <main class="container-center">
    <div class="addporto-form-container">
      <form action="/createPorto" method="post" id="formAddPorto" name="formAddPorto" enctype="multipart/form-data">
